  ...
  return (
    <div className='fixed inset-0 backdrop-blur-sm bg-black/20 z-50 flex items-center justify-center p-4'>
        ...
        relative p-6 animate-fadeIn'>
            ...
            {/* Form to fill to create a taask */}
            <form onSubmit={handleSubmit} className='space-y-4'>
              {error && <div className='text-sm text-red-600 bg-red-50 p-3 
              rounded-lg border border-red-100 '>{error}</div>}
              <div>
              ...
              <div>
                ...
                <div className='flex gap-4'>
                  {[{val: 'Yes', label: 'Completed'}, {val: 'No', label: 'In Progress'}].map(({val, label}) => (
                    ...
                    onChange={handleChange} className='w-4 h-4 text-purple-600
