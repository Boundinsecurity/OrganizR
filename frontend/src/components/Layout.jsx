...
const Layout = ({onLogout, user}) => {
   ...
   const stats = useMemo(() => {
        ...
        const completionPerecentage = totalCount ?
        ...
        <div className='ml-0 xl:ml-64 lg:ml-64 md:ml-16 pt-16 p-3 sm:p-4 md:p-4 transition-all duration-300'>
            <div className='grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6 '>
                ...
                <div className='xl:col-span-1 space-y-4 sm:space-y-6'>
                            ...
                            <div className='relative p-1'>
                                <div className='flex gap-1.5 items-center'>
                                    <div className='flex-1 h-2 sm:h-3 bg-purple-100 rounded-full overflow-hidden'>
                                        ...
                                        style={{width: `${stats.completionPerecentage}%`}}/>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-b-purple-100'>
                        <h3 className='text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-800 flex items-center gap-2'>
                        ...
                        <div className='space-y-2 sm:space-y-3 '>
                            {tasks.slice(0,3).map((task) => (
                                <div key={task._id || task.id} className='flex items-center justify-between p-2 sm:p-3 hover:bg-purple-50/50 rounded-lg transition-colors duration-200
